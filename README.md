...
- **Интеграция с Telegram-ботом** — отправка отчётов с ИИ-аналитикой
- **ИИ-аналитика** — расчёт стабильности, трендов, прогнозов и рекомендаций
...
## 🤖 ИИ-аналитика в Telegram-боте

Отчёт, отправляемый в Telegram, включает:

- **Общую статистику** — общая и средняя производительность
- **Коэффициент вариации** — оценка стабильности работы группы
- **Лучший и худший работник** — с расчётом разрыва
- **ИИ-рекомендации** — на основе анализа данных
- **Тренд** — рост, падение или стабильность
- **Прогноз** — ожидаемая производительность в следующем периоде
...
| Telegram API | Отправка отчётов и аналитика |
...
# 5. Настраиваем Telegram бота (опционально)
# В .env добавьте:
...
# 7. Выполняем миграции и заполняем БД тестовыми данными
...
# 11. Настройка Telegram бота (после добавления токена в .env)
# Чтобы получить токен:
#   1. Найдите в Telegram @BotFather
#   2. Отправьте команду /newbot и создайте бота
...
#   3. Скопируйте "chat":{"id":123456789} в .env: TELEGRAM_CHAT_ID=123456789
#
# После настройки на странице статистики появится кнопка "Отправить в Telegram"
